...
config.General.requestName = 'TTbar_14TeV_step3_trackingOnly_921_PU200_OT613_200_IT4025'
config.General.workArea = 'crab'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'step3_RAW2DIGI_RECO_VALIDATION_DQM_trackingOnly_PU200_OT613_200_IT4025.py'
