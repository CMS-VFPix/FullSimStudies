...
# with command line options: FourMuExtendedPt_1_200_pythia8_cfi --conditions auto:phase2_realistic -n 10 --era Phase2C2 --eventcontent FEVTDEBUG --relval 10000,100 -s GEN,SIM --datatier GEN-SIM --beamspot HLLHC --geometry Extended2023D4 --fileout file:step1.root
...
fileNames =["pixbar.xml","pixel.xml","pixelProdCuts.xml","pixelRecoMaterial.xml","pixelStructureTopology.xml","pixelsens.xml","pixfwd.xml","tracker.xml","trackerProdCuts.xml","trackerRecoMaterial.xml","trackerStructureTopology.xml","trackersens.xml"]
