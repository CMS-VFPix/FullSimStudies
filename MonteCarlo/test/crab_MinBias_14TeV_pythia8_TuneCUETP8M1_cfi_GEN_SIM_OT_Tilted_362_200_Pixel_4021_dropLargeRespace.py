...
config.General.requestName = 'MinBias_14TeV_GenSim_dropLargeRespace_duplicateMaterialRemoved'
...
config.Data.outputPrimaryDataset = 'MinBias_14TeV_900pre4_dropLargeRespace_duplicateMaterialRemoved'
