...
for i in range (0, len (process.XMLIdealGeometryESSource.geomXMLFiles)):
    ...
    if not xmlFile.endswith ("trackerStructureTopology_80x208.xml"):
        continue
    process.XMLIdealGeometryESSource.geomXMLFiles[i] = "VFPix/MonteCarlo/data/trackerStructureTopology_80x208.xml"
