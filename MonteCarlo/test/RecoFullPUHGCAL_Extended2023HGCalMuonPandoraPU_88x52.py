...
for i in range (0, len (process.XMLIdealGeometryESSource.geomXMLFiles)):
    ...
    if not xmlFile.endswith ("trackerStructureTopology_88x52.xml"):
        continue
    process.XMLIdealGeometryESSource.geomXMLFiles[i] = "VFPix/MonteCarlo/data/trackerStructureTopology_88x52.xml"
